 ...
 * Use the {@link RecipeHome#newInstance} factory method to
...
public class RecipeHome extends Fragment {
    ...
    public static RecipeHome newInstance(String param1, String param2) {
        RecipeHome fragment = new RecipeHome();
